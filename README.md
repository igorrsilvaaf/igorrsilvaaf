<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:833ab4,50:fd1d1d,100:fcb045&height=200&section=header&text=Igor%20Silva&fontSize=50&fontColor=fff&animation=twinkling&fontAlignY=35&desc=QA%20Engineer%20Full%20Stack%20|%20Especialista%20em%20Automação%20de%20Testes&descAlignY=55&descSize=18"/>
...
<img align="right" width="400" src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcDd2OHRiY2pocXQ1OWJ0NmRtMjU0aG1mOXFubGp2cWZlcjdzOGZkZyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/qgQUggAC3Pfv687qPC/giphy.gif"/>

```javascript
const igor = {
  cargo: "QA Engineer Full Stack",
  localizacao: "Brasil 🇧🇷",
  formacao: {
    graduacao: "Análise e Desenvolvimento de Sistemas",
    posGraduacao: "Engenharia da Computação"
  },
  especialidades: [
    "Testes E2E", 
    "Testes de API", 
...
🔭 **Trabalhando com:** Automação de Testes E2E, API & Performance

🌱 **Estudando:** Testes de Segurança (OWASP, Penetration Testing)

🎯 **Objetivo:** Garantir qualidade de software em todas as camadas

💬 **Pergunte-me sobre:** Cypress, Playwright, k6, Estratégias de Teste

⚡ **Curiosidade:** Transformo bugs em features documentadas!
...
<a href="https://www.instagram.com/igor.codes/" target="_blank">
<img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white"/>
</a>

<br><br>

### 💼 Aberto para colaborações e oportunidades em QA/Automação de Testes!
